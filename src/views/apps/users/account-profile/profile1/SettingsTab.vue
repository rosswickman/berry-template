      ...
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            ...
            <v-switch v-model="email1" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">Email Notification</span>
              </template>
            </v-switch>

            <v-switch v-model="email2" color="primary" hide-details class="text-truncate">
              <template #label>
            ...
            <v-switch v-model="email3" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">have new notifications</span>
              </template>
            </v-switch>

            <v-switch v-model="email4" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">you're sent a direct message</span>
              </template>
            </v-switch>

            <v-switch v-model="email5" color="primary" hide-details class="text-truncate">
              <template #label>
            ...
            <v-switch v-model="email6" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">Upon new order</span>
              </template>
            </v-switch>

            <v-switch v-model="email7" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">New membership approval</span>
              </template>
            </v-switch>

            <v-switch v-model="email8" color="primary" hide-details class="text-truncate">
              <template #label>
            ...
            <v-checkbox v-model="checkbox1" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">News about PCT-themes products and feature updates</span>
              </template>
            </v-checkbox>
            <v-checkbox v-model="checkbox2" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">Tips on getting more out of PCT-themes</span>
              </template>
            </v-checkbox>
            <v-checkbox v-model="checkbox3" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">Things you missed since you last logged into PCT-themes</span>
              </template>
            </v-checkbox>
            <v-checkbox v-model="checkbox4" color="primary" hide-details class="text-truncate">
              <template #label>
                <span class="text-truncate">News about products and other services</span>
              </template>
            </v-checkbox>
            <v-checkbox v-model="checkbox5" color="primary" hide-details class="text-truncate">
              <template #label>
