      ...
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            ...
            <v-switch v-model="secure" color="primary" class="text-truncate">
              <template #label>
            ...
            <v-switch v-model="login" color="primary" class="text-truncate">
              <template #label>
            ...
            <v-switch v-model="approve" color="primary" class="text-truncate">
              <template #label>
              ...
              <v-list-item v-for="(recognize, i) in recognizes" :key="i" color="primary" class="px-0">
                ...
                <template #append>
                  <span v-if="recognize.active" class="text-success">
                    <v-icon class="text-8 mr-1" icon="$circle"></v-icon>
