      ...
      <UiParentCard title="Customer List">
        ...
        <v-row v-for="card in listCards" :key="card.name">
          ...
          <v-col md="5" sm="6" cols="12">
            ...
            <v-row>
              <v-col col="6">
                <v-btn color="secondary" variant="outlined" block size="small"><MessageIcon size="16" class="mr-1" /> Message</v-btn>
              </v-col>
              <v-col col="6">
                <v-btn color="error" variant="outlined" block size="small"><BanIcon size="16" class="mr-1" /> Block</v-btn>
              </v-col>
            </v-row>
          </v-col>
